      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <a href="{{ route('film.create') }}" class="btn btn-small btn-success">Create</a>
                  ...
                  <tr>
                    ...
                    <td class="d-flex" style="gap:10px">
                      <a href="{{ route('film.show', $film->id) }}" class="btn btn-small btn-info">Detail</a>
                      <a href="{{ route('film.edit', $film->id) }}" class="btn btn-small btn-warning">Edit</a>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Apakah Anda Yakin Akan Menghapus Data Film</p>
                  </div>
